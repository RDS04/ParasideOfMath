...
<head>
    ...
    <style>
        ...
        .main-sidebar {
            background: linear-gradient(180deg, var(--pom-violet-deep) 0%, var(--pom-violet) 100%) !important;
        }
        ...
        .card {
            ...
            box-shadow: 0 1px 2px rgba(46, 16, 101, 0.04), 0 10px 24px -14px rgba(76, 29, 149, 0.14);
        }
        ...
        .btn-brand {
            background: linear-gradient(135deg, var(--pom-amber-light), var(--pom-amber));
            border: none;
            color: #40206b;
            font-weight: 700;
        }
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
    <div class="wrapper">
        ...
        @if($pollEndpoint)
            ...
            <div id="global-notif-toast"
                class="fixed bottom-4 right-4 z-50 bg-purple-900 text-white px-4 py-3 rounded-2xl shadow-2xl border border-purple-700 flex items-center gap-3 hidden animate-bounce">
                <div
                    class="w-8 h-8 rounded-full bg-amber-400 text-purple-950 flex items-center justify-center font-bold flex-shrink-0">
                ...
                <button onclick="requestGlobalNotifPermission()"
                    class="bg-amber-400 hover:bg-amber-300 text-purple-950 text-xs font-black px-3 py-1.5 rounded-xl shadow transition">
                    Izinkan
                </button>
