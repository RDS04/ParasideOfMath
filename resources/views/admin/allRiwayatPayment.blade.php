                                            ...
                                            <td class="px-4 py-3.5 text-center align-middle no-print">
                                                <div class="d-flex justify-content-center align-items-center gap-1.5">
                                                    @if($pay->status === 'under_review')
                                                        <a href="{{ route('admin.approve-pembayaran.index') }}" class="btn btn-xs btn-amber text-xs font-weight-bold rounded-lg px-2.5 py-1.5 text-white" style="background-color: #f59e0b;" title="Verifikasi Pembayaran">
