...
<head>
    ...
    <title>Daftar Administrator · Paradise of Math</title>
    ...
    <div class="panel-left hidden lg:flex relative overflow-hidden flex-col justify-between px-14 py-12 text-white">
        ...
        <div class="relative z-10 flex-1 flex items-center justify-center py-6">
            <svg viewBox="0 0 460 340" class="w-full max-w-md" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g>
                    ...
                    <text x="40" y="288" fill="rgba(255,255,255,0.75)" font-size="13" text-anchor="middle" font-family="Inter, sans-serif">Database</text>
                </g>
                <g>
                    ...
                    <text x="210" y="218" fill="rgba(255,255,255,0.75)" font-size="13" text-anchor="middle" font-family="Inter, sans-serif">Keamanan</text>
                </g>
                <g>
                    ...
                    <text x="420" y="70" fill="rgba(255,255,255,0.75)" font-size="13" text-anchor="middle" font-family="Inter, sans-serif">Manajemen</text>
                </g>
            </svg>
        </div>
        ...
        <div class="relative z-10 max-w-sm">
            ...
            <p class="text-white/60 text-sm mt-3 leading-relaxed">
                Kelola data bimbingan, jadwal siswa, tutor, dan pantau perkembangan belajar secara keseluruhan dari satu dashboard terpusat.
            </p>
        </div>
    </div>
    ...
    <div class="flex items-center justify-center px-5 py-10 sm:px-10 relative">
        <div class="w-full max-w-md">
            ...
            <div class="lg:hidden text-center mb-8">
                ...
                <p class="text-xs text-gray-400 tracking-wide uppercase mt-1">Registrasi Administrator</p>
            </div>

            <div class="hidden lg:block mb-8">
                <h1 class="font-display text-2xl font-semibold text-[#2e1065]">Daftar Akun Admin</h1>
                <p class="text-sm text-gray-500 mt-1">Buat akun untuk masuk ke dashboard manajemen LBB.</p>
            </div>

            <!-- FORM REGISTER ADMIN -->
            <form id="formRegisterAdmin" class="space-y-4" action="{{ route('admin.register.post') }}" method="POST">
                @csrf
                ...
                <div class="field-group">
                    ...
                    <input type="email" id="regEmail" name="email" value="{{ old('email') }}" placeholder="Alamat email admin" autocomplete="email" required />
                    @error('email')
                        <p class="text-xs text-rose-500 mt-1 pl-1 font-medium">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex items-start gap-2.5 pt-0.5">
                    ...
                    <label for="regTerms" class="text-sm text-gray-600 leading-snug select-none cursor-pointer">
                        Saya menjamin data pendaftaran di atas adalah valid dan merupakan hak akses administratif.
                    </label>
                </div>
            ...
            <div class="mt-8 pt-5 border-t border-gray-100 text-center">
                <p class="text-xs text-gray-400 tracking-wide">
                    &copy; 2026 · Paradise of Math — Panel Administrasi
                </p>
            </div>
        </div>
    </div>
