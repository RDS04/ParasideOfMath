                ...
                <div class="card border-0 shadow-sm rounded-2xl mb-4 bg-white overflow-hidden">
                    <div class="card-body p-5 text-center">
                        ...
                        <p class="text-slate-500 text-sm max-w-md mx-auto mb-0">
                            Pilih <span class="font-bold text-purple-900">Jenjang</span>, <span
                                class="font-bold text-purple-900">Kelas</span>, <span
                                class="font-bold text-purple-900">Semester/TKA</span>, dan <span
                                class="font-bold text-purple-900">Mata Pelajaran</span> pada filter dropdown di atas untuk
            ...
            @if ($selectedCategory)
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 mb-4">
                        <div class="card border-0 shadow-sm rounded-2xl bg-white overflow-hidden h-100">
                            ...
                            <div class="card-header bg-white p-2 border-bottom">
                                <ul class="nav nav-pills nav-fill font-bold text-xs gap-2" id="tabMenuBankSoalAdmin"
                                    role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button
                                            ...
                                            id="tab-manual-admin-btn" data-toggle="pill" data-target="#tab-manual-admin-content"
                                            type="button" role="tab" aria-controls="tab-manual-admin-content"
                                            aria-selected="true">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button
                                            ...
                                            id="tab-upload-admin-btn" data-toggle="pill" data-target="#tab-upload-admin-content"
                                            type="button" role="tab" aria-controls="tab-upload-admin-content"
                                            aria-selected="false">
                            ...
                            <div class="card-body p-4 bg-slate-50/40 tab-content" id="tabMenuBankSoalAdminContent">
                                ...
                                <div class="tab-pane fade" id="tab-upload-admin-content" role="tabpanel"
                                    aria-labelledby="tab-upload-admin-btn">
                                    <form action="{{ route($prefixRoute . '.import.preview') }}" method="POST"
                                        ...
                                        <div
                                            ...
                                            <p class="text-purple-800 mb-0 leading-relaxed">
                                                ...
                                                mengimpor atau menyimpan dokumen soal.
                                            </p>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div
                                                ...
                                                <small class="text-slate-400 d-block mt-2">Ukuran maksimal file: 10MB</small>
                                            </div>
                                        </div>
                    ...
                    <div class="col-lg-7 mb-4">
                        @php
                            $adminCatDocFiles = glob(public_path("uploads/bank_soal_docs/doc_{$selectedCategory->id}_*.*")) ?: [];
                        @endphp

                        @if(count($adminCatDocFiles) > 0)
                            <!-- DAFTAR DOKUMEN (PDF / WORD) TERSIMPAN -->
                            <div class="card border-0 shadow-sm rounded-2xl mb-4 bg-white overflow-hidden">
                                <div class="card-header py-3 px-4 d-flex justify-content-between align-items-center" style="background: linear-gradient(135deg, #4c1d95, #6b21a8) !important; color: #ffffff !important; border: none !important;">
                                    <h5 class="card-title font-bold text-white mb-0 text-sm d-flex align-items-center" style="color: #ffffff !important;">
                                        <i class="fas fa-file-pdf text-amber-300 mr-2 fa-lg"></i> Dokumen Soal (PDF / Word) Tersimpan ({{ count($adminCatDocFiles) }} File)
                                    </h5>
                                    <span class="badge text-xs px-2.5 py-1 rounded-md font-bold" style="background-color: rgba(255, 255, 255, 0.2) !important; color: #fef08a !important; border: 1px solid rgba(255, 255, 255, 0.3) !important;">
                                        Server Storage
                                    </span>
                                </div>
                                <div class="card-body p-2 p-sm-3 bg-slate-50/50">
                                    <div class="d-flex flex-column gap-2">
                                        @foreach($adminCatDocFiles as $adDocIdx => $adDocPath)
                                            @php
                                                $adDocFileName = basename($adDocPath);
                                                $adDocExt = strtolower(pathinfo($adDocFileName, PATHINFO_EXTENSION));
                                                $adDocDisplay = preg_replace('/^doc_\d+_\d+_/', '', $adDocFileName);
                                                $adDocUrl = asset("uploads/bank_soal_docs/{$adDocFileName}");
                                                $isPdf = $adDocExt === 'pdf';
                                                $isWord = in_array($adDocExt, ['doc', 'docx']);
                                            @endphp
                                                ...
                                                <div class="d-flex items-center gap-3 min-w-0 flex-1">
                                                    ...
                                                    <div class="min-w-0 flex-1">
                                                        <div class="d-flex items-center gap-2 flex-wrap mb-0.5">
                                                            <h6 class="font-bold text-xs sm:text-sm text-purple-950 text-truncate mb-0" title="{{ $adDocDisplay }}">{{ $adDocDisplay }}</h6>
                                                            <span class="badge {{ $isPdf ? 'bg-rose-50 text-rose-700 border-rose-200' : 'bg-blue-50 text-blue-700 border-blue-200' }} border px-2 py-0.5 rounded text-[10px] uppercase font-bold">
                                                                DOKUMEN {{ strtoupper($adDocExt) }}
                                                            </span>
                                                        </div>
                                                        <span class="text-[11px] text-slate-400 d-block text-truncate">File Dokumen Bank Soal Admin</span>
                                                    </div>
                                                </div>
                                                <div class="d-flex items-center gap-2 shrink-0">
                                                    @if($isPdf)
                                                        <button type="button" class="btn btn-xs font-bold rounded-xl px-3.5 py-2 d-flex items-center justify-center gap-1.5 text-xs text-white shadow-xs" data-toggle="modal" data-target="#modalAdminPreviewDoc_{{ $adDocIdx }}" style="background: linear-gradient(135deg, #6b21a8, #4c1d95) !important; color: #ffffff !important; border: none !important;">
                                                            <i class="fas fa-book-reader text-amber-300"></i> Baca Dokumen PDF
                                                        </button>
                                                    @endif
                                                    <form action="{{ route('admin.bank-soal.delete-doc') }}" method="POST" class="d-inline m-0" onsubmit="return confirm('Apakah Anda yakin ingin menghapus dokumen ini?')">
                                                        @csrf
                                                        @method('DELETE')
                                                        <input type="hidden" name="filename" value="{{ $adDocFileName }}">
                                                        <button type="submit" class="btn btn-xs btn-outline-danger font-bold rounded-xl px-3 py-2 d-flex items-center justify-center gap-1.5 text-xs shadow-xs" title="Hapus Dokumen">
                                            ...
                                            <!-- MODAL PREVIEW PDF DOKUMEN ADMIN (PROTEKSI UNDUH & FULLSCREEN) -->
                                            @if($isPdf)
                                                <div class="modal fade p-0" id="modalAdminPreviewDoc_{{ $adDocIdx }}" tabindex="-1" role="dialog" aria-hidden="true" style="padding-right: 0 !important;">
                                                        ...
                                                        <div class="modal-content border-0 rounded-0 shadow-none h-100 bg-slate-900">
                                                            <div class="modal-header bg-purple-950 text-white p-2.5 p-sm-3 border-bottom border-purple-800 d-flex flex-row justify-content-between align-items-center gap-2">
                                                                <div class="d-flex align-items-center gap-2 min-w-0">
                                                                    ...
                                                                    <div class="min-w-0">
                                                                        <h5 class="modal-title font-bold text-xs sm:text-sm text-white mb-0 text-truncate" style="max-width: 60vw;">{{ $adDocDisplay }}</h5>
                                                            ...
                                                            <div class="modal-body p-0 bg-slate-900 overflow-hidden" style="height: calc(100vh - 58px); user-select: none;" oncontextmenu="return false;">
                                                                <iframe src="{{ $adDocUrl }}#toolbar=0&navpanes=0&scrollbar=1&view=FitH" class="w-100 h-100 border-0" style="min-height: 100%;" oncontextmenu="return false;"></iframe>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="card border-0 shadow-sm rounded-2xl bg-white mb-4 overflow-hidden">
                            <div
                                ...
                                <span
                                    class="badge bg-amber-100 text-amber-900 border border-amber-200 font-bold px-2.5 py-1 rounded-lg text-xs d-inline-flex align-items-center">
                            ...
                            <div class="card-body p-4 bg-purple-50/20">
                                <div class="card border-2 border-purple-300 rounded-xl shadow-sm overflow-hidden bg-white mb-0">
                                    <div
                                        class="card-header bg-purple-50 py-2.5 px-3.5 d-flex justify-content-between align-items-center border-bottom">
                                        <div class="d-flex align-items-center gap-2">
                                            <span
                                            ...
                                            <span
                                                ...
                                                id="preview_kunci_badge">
                                                Kunci: A
                                            </span>
                                        </div>
                                        <span class="text-xs text-slate-400 font-semibold italic"><i
                                                class="fas fa-pencil-alt mr-1"></i> Penulisan Soal Baru</span>
                                    </div>
                                    <div class="card-body p-3.5">
                                        <p class="font-bold text-slate-900 mb-3 text-sm whitespace-pre-line"
                                            id="preview_soal_text">Tuliskan teks pertanyaan di sebelah kiri untuk melihat
                                            pratinjau hasil tampilan soal di sini...</p>
                                        <div class="row g-2">
                                            <div class="col-md-6 mb-2">
                                                <div class="p-2.5 rounded-xl border text-xs font-semibold d-flex align-items-start bg-emerald-50 border-emerald-300 text-emerald-950 font-bold"
                                                    id="preview_opsi_a_box">
                                                    <span
                                                        class="badge bg-emerald-600 text-white mr-2 px-2 py-1 rounded-md text-xs font-bold"
                                                        id="preview_badge_a">A</span>
                                                    <span class="flex-1 mt-0.5" id="preview_opsi_a_text">Opsi Jawaban
                                                        A...</span>
                                                    <i class="fas fa-check-circle text-emerald-600 ml-1.5 mt-0.5"
                                                        id="preview_icon_a"></i>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-2">
                                                <div class="p-2.5 rounded-xl border text-xs font-semibold d-flex align-items-start bg-slate-50 border-slate-200 text-slate-700"
                                                    id="preview_opsi_b_box">
                                                    <span
                                                        class="badge bg-slate-200 text-slate-700 mr-2 px-2 py-1 rounded-md text-xs font-bold"
                                                        id="preview_badge_b">B</span>
                                                    <span class="flex-1 mt-0.5" id="preview_opsi_b_text">Opsi Jawaban
                                                        B...</span>
                                                    <i class="fas fa-check-circle text-emerald-600 ml-1.5 mt-0.5 d-none"
                                                        id="preview_icon_b"></i>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-2">
                                                <div class="p-2.5 rounded-xl border text-xs font-semibold d-flex align-items-start bg-slate-50 border-slate-200 text-slate-700"
                                                    id="preview_opsi_c_box">
                                                    <span
                                                        class="badge bg-slate-200 text-slate-700 mr-2 px-2 py-1 rounded-md text-xs font-bold"
                                                        id="preview_badge_c">C</span>
                                                    <span class="flex-1 mt-0.5" id="preview_opsi_c_text">Opsi Jawaban
                                                        C...</span>
                                                    <i class="fas fa-check-circle text-emerald-600 ml-1.5 mt-0.5 d-none"
                                                        id="preview_icon_c"></i>
                                                </div>
                                            ...
                                            <div class="col-md-6 mb-2">
                                                <div class="p-2.5 rounded-xl border text-xs font-semibold d-flex align-items-start bg-slate-50 border-slate-200 text-slate-700"
                                                    id="preview_opsi_d_box">
                                                    <span
                                                        class="badge bg-slate-200 text-slate-700 mr-2 px-2 py-1 rounded-md text-xs font-bold"
                                                        id="preview_badge_d">D</span>
                                                    <span class="flex-1 mt-0.5" id="preview_opsi_d_text">Opsi Jawaban
                                                        D...</span>
                                                    <i class="fas fa-check-circle text-emerald-600 ml-1.5 mt-0.5 d-none"
                                                        id="preview_icon_d"></i>
                                                </div>
