...
<body class="min-h-screen flex flex-col items-center justify-center p-4 sm:p-8">
    ...
    <div class="w-full max-w-5xl mb-8">
        <div class="flex items-center justify-between max-w-xl mx-auto px-4">
            ...
            <div class="flex flex-col items-center">
                ...
                <span class="text-[10px] sm:text-xs font-semibold text-slate-400 mt-2">Pembayaran</span>
            </div>
    ...
    <div
        class="w-full max-w-5xl bg-white rounded-3xl shadow-xl overflow-hidden border border-purple-100 grid grid-cols-1 lg:grid-cols-12">
                ...
                <form action="{{ route('siswa.payment') }}" method="GET" class="space-y-5">
                    ...
                    <div class="mb-4">
                        <label class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Pilih Tipe
                            Pertemuan (Jumlah Peserta)</label>
