...
<head>
    ...
    <style>
        ...
        .discount-round-seal {
            ...
            box-shadow: 0 16px 36px rgba(225, 29, 72, 0.55), inset 0 0 15px rgba(0, 0, 0, 0.25);
            display: flex;
            align-items: center;
            justify-content: center;
            text-align: center;
        ...
        /* Heartbeat (Heart Pulse & Breathing) Animation - Ultra Vibrant */
        @keyframes heartbeat {
            0% {
            ...
            <div class="text-center md:text-left reveal-element">
                ...
                <h1
                    ...
                    <div class="relative inline-block">
                        ...
                        <!-- Badge Bubble Diskon "Bimbel & Privat Terpercaya" (Ultra Eye-Catching & Huge Heartbeat Seal Badge) -->
                        <div
                            class="absolute -top-20 -right-10 sm:-top-24 sm:-right-16 md:-top-28 md:-right-24 z-30 animate-heartbeat hover:scale-110 transition-all duration-300 cursor-pointer">
                            <!-- Dual Glow aura pulse background (Heartbeat synced) -->
                            <div
                                class="absolute -inset-5 rounded-full bg-gradient-to-r from-amber-400 via-rose-500 to-yellow-300 opacity-75 blur-2xl animate-heartbeat-glow pointer-events-none">
                            </div>

                            <!-- Outer white ring frame -->
                            <div
                                class="w-[210px] h-[210px] sm:w-[265px] sm:h-[265px] md:w-[310px] md:h-[310px] rounded-full bg-white p-[6px] sm:p-[9px] shadow-[0_25px_60px_rgba(225,29,72,0.65)] relative overflow-hidden group">
                                <!-- Inner badge container -->
                                <div
                                    class="w-full h-full rounded-full border-3 sm:border-4 border-dashed border-amber-300 bg-gradient-to-br from-rose-600 via-red-600 via-amber-500 to-yellow-400 flex flex-col items-center justify-center text-center p-4 sm:p-7 relative z-10 shadow-inner">
                                    <!-- Glossy Highlight Effect -->
                                    <div
                                        class="absolute inset-0 rounded-full bg-gradient-to-b from-white/45 via-white/15 to-transparent pointer-events-none">
                                    </div>

                                    <!-- Sparkles icon -->
                                    <div
                                        class="flex items-center gap-1.5 text-amber-300 text-lg sm:text-2xl md:text-3xl font-black leading-none mb-1.5 sm:mb-2 animate-pulse drop-shadow">
                                        <span>✨</span>
                                        <span>✦</span>
                                        <span>✨</span>
                                    </div>
                                    ...
                                    <!-- Main Title text -->
                                    <span
                                        class="text-white font-black text-xl sm:text-3xl md:text-6xl lg:text-[2.5rem] leading-none uppercase tracking-tighter drop-shadow-[0_4px_8px_rgba(0,0,0,0.6)] px-2">
                                        BIMBEL &amp; PRIVAT
                                    </span>

                                    <!-- Pill Subtitle text -->
                                    <span
                                        class="bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-300 text-purple-950 font-black text-xs sm:text-lg md:text-xl px-4 sm:px-7 py-1 sm:py-2 rounded-full uppercase tracking-widest block mt-3 sm:mt-4 shadow-[0_8px_20px_rgba(245,158,11,0.6)] border-2 border-white/90 transform hover:scale-105 transition-transform">
                                        Exclusive
                                    </span>
                                </div>
                            </div>
    ...
    <section id="youtube-tutorial"
        ...
        <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 relative z-10">
            ...
            @php
                ...
                $firstUrl = $hasLinks ? $firstVideo->youtube_url : 'https://youtube.com/@paradiseofmath5636?si=uz3WlKN6i3MPzWL0';
            @endphp
